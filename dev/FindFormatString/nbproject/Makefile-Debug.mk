...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/findformatstring.exe
...
${OBJECTDIR}/_ext/6e7c8a8c/util.o: ../../misc/util.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -I../.. -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/6e7c8a8c/util.o ../../misc/util.c
