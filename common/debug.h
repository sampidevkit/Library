...
#else
#define task_debug(fnc)             
#define nontask_debug(fnc)          
// Debug for non-functions
...
#define __dbh_t(x, dg)              
#define __dbh2_t(x)                 
#define __dbhs_t(str, len)          
#define __dbdata_t(str, len)        
// Debug for non-functions
#define __dbsi(str, x)              
#define __dbsu(str, x)              
#define __dbsh(str, x)              
...
// Debug for task-functions
#define __dbsi_t(str, x)            
#define __dbsu_t(str, x)            
#define __dbsh_t(str, x)            
#define __dbsc_t(str, c)            
#define __dbss_t(str1, str2)        
#define __dbstime_t(str, tcxt)      
#define __dbsdate_t(str, tcxt)      
#define __dbsdata_t(str, pd, len)   

// Debug for non-functions 
#define __tsdbs(str)                
#define __tsdbsi(str, x)            
#define __tsdbsu(str, x)            
#define __tsdbsh(str, x)            
#define __tsdbsc(str, c)            
#define __tsdbss(str1, str2)        
#define __tsdbstime(str, tcxt)      
#define __tsdbsdate(str, tcxt)      
#define __tsdbsdata(str, pd, len)   
// Debug for task-functions
#define __tsdbs_t(str)              
#define __tsdbsi_t(str, x)          
#define __tsdbsu_t(str, x)          
#define __tsdbsh_t(str, x)          
#define __tsdbsc_t(str, c)          
#define __tsdbss_t(str1, str2)      
#define __tsdbstime_t(str, tcxt)    
#define __tsdbsdate_t(str, tcxt)    
#define __tsdbsdata_t(str, pd, len) 
#endif