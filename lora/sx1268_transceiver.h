...
uint8_t sx1268_transceiver_send(const uint8_t *pD, uint8_t len);
uint8_t sx1268_transceiver_receive(uint8_t *pD, uint8_t len);
void sx1268_transceiver_task(void);
