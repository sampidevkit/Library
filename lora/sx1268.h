 ...
 * @param[out] *info pointer to an sx1268 info structure
 * @return     status code
 *             - 0 success
 *             - 2 handle is NULL
 * @note       none
...
/* *********************************************************************************** */
/**
 * @defgroup sx1268_interface_driver sx1268 interface driver function
 * @brief    sx1268 interface driver modules
 * @ingroup  sx1268_driver
 * @{
 */
